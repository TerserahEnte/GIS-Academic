...
<body>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', async () => {
            ...
            //     [339 , 342 , 243 , 240 , 254 , 253 , 235 , 236 , 237 , 238 , 252 , 251 , 241 , 341 , 351 , 350 , 330 , 332 , 321],
            //     "#ff0000"
            // );

            // await addManualRoute(
            //     [339 , 342 , 243 , 240 , 254 , 255 , 233 , 234 , 257 , 256 , 250 , 251 , 241 , 341 , 351 , 350 , 330 , 332 , 321],
            //     "#00ff00"
            // );

            // await addManualRoute(
            //     [339 , 340 , 343 , 442 , 439 , 440 , 454 , 455 , 433 , 434 , 457 , 456 , 450 , 451 , 441 , 341 , 351 , 350 , 330 , 332 , 321],
            //     "#0000ff"
            // );
            // await addManualRoute(
            //     [339 , 340 , 343 , 442 , 439 , 440 , 454 , 453 , 435 , 436 , 437 , 438 , 452 , 451 , 441 , 341 , 351 , 350 , 330 , 332 , 321],
            //     "#ffff00"
            // );
            ...
            // Case 3 Multi Floor
            await addManualRoute(
                [110 , 133 , 152 , 153 , 154 , 140 , 242 , 239 , 240 , 243 , 342 , 339 , 340 , 343 , 442 , 439 , 440 , 454 , 455 , 433 , 434 , 411],
                "#ff0000"
            );

            await addManualRoute(
                [110 , 133 , 151 , 150 , 156 , 157 , 155 , 134 , 135 , 154 , 140 , 242 , 239 , 240 , 243 , 342 , 339 , 340 , 343 , 442 , 439 , 440 , 454 , 455 , 433 , 434 , 411],
                "#00ff00"
            );
            await addManualRoute(
